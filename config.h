...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,	        XK_p,		       spawn,		SHCMD("wallpaper") },
	...
	//{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("notify-send 'is the volume button working?'") },
